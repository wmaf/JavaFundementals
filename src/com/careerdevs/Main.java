...
public class Main {
    ...
    Constructor myConstructor = new Constructor("Bill", 45);
    System.out.println(myConstructor.name);

        Car myCars1 = new Car("Chevy", "Camaro 2SS", 10000, 0.10F);
        Car myCars2 = new Car("Ford", " Mustang GT", 30000, 0.50F);
        Car myCars3 = new Car("Dodge", "Hellcat", 100, 0.90F);
